...
public class EmployeeController {
    ...
    public String testObj(Employee e, Model model) {
        model.addAttribute("emp", e.toString());
        return "index";
    }

    @RequestMapping("/xmlOrJsonSimple/{id}")
    @ResponseBody
    public Employee xmlOrJsonSimple(@PathVariable Integer id) {
